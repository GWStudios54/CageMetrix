...
test('specialized source workflows still trigger from their own evidence code',()=>{
  assert.match(read('.github/workflows/availability-sync.yml'),/scripts\/sync-availability\.mjs/);
...
test('fighter-intel PR validation stays isolated from production refresh concurrency',()=>{
