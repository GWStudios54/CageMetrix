...
function talentWhere(url:URL){
  ...
  return {clauses,binds,filters:{q:q||null,division:division||null,promotion:promotion||null,region:region||null,country:country||null,management:management||null,contract:contract||null,opportunity:opportunity||null,age_max:ageMax,age_min:ageMin,min_rating:minRating,min_evidence:minEvidence,min_wins:minWins,active_months:activeMonths}};
}
