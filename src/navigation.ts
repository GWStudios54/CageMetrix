...
export function primaryNavigation(admin=false){
  return `<a href="/scout">Scout AI</a><a href="/#rankings">Rankings</a><a href="/scout?q=Find%20the%20best%20regional%20MMA%20prospects%20under%2025">Prospects</a><a href="/talent">Talent</a><a href="/promotions">Promotions</a><a href="/events">Events</a>${admin?'<a href="/admin" class="admin-link">Admin</a>':''}`;
}
