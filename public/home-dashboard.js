(()=>{
  ...
  if(hero&&!document.querySelector('.home-research-entry')){
    ...
    section.innerHTML=`<div class="home-ask-shell"><div class="home-ask-copy"><span class="eyebrow">ASK MMA SCOUTS</span><strong>Research the sport in plain English.</strong><small>Ask about fighters, matchups, prospects, résumés, rankings, or relationships across MMA history.</small></div><form class="home-ask-form" data-home-scout-form><label class="sr-only" for="home-scout-question">Ask MMA Scouts a research question</label><input id="home-scout-question" name="question" maxlength="500" autocomplete="off" placeholder="Ask MMA Scouts anything…"><button class="button primary" type="submit">Search</button></form><div class="home-sample-links"><span>Try:</span><a href="/scout?question=Compare%20Ilia%20Topuria%20and%20Islam%20Makhachev">Compare Topuria vs Makhachev</a><a href="/scout?question=Find%20undefeated%20regional%20fighters%20under%2025">Find prospects under 25</a><a href="/scout?question=Which%20active%20fighters%20had%20the%20strongest%20documented%20pre-UFC%20resumes%3F">Best pre-UFC résumés</a></div></div><div class="home-tool-grid"><a class="home-tool-card" href="/scout"><span class="home-tool-icon">⌕</span><div><strong>Scout AI</strong><small>Ask questions. Get evidence-backed answers.</small></div><b>→</b></a><a class="home-tool-card" href="/#rankings"><span class="home-tool-icon">▤</span><div><strong>Fighter Reports</strong><small>Ratings, history, résumé and career context.</small></div><b>→</b></a><a class="home-tool-card" href="/predictions.html"><span class="home-tool-icon">↔</span><div><strong>Matchup Scout</strong><small>Model probabilities and matchup analysis.</small></div><b>→</b></a><a class="home-tool-card" href="/#rankings"><span class="home-tool-icon">▥</span><div><strong>Scout Rankings</strong><small>Opponent-adjusted performance and schedule.</small></div><b>→</b></a><a class="home-tool-card" href="/scout?question=Find%20the%20best%20regional%20MMA%20prospects"><span class="home-tool-icon">☆</span><div><strong>Prospect Scout</strong><small>Search the next generation of fighters.</small></div><b>→</b></a></div>`;
